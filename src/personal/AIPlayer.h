 ...
 * variar.
 */
// float Poda_AlfaBeta(const Parchis &actual, int jugador, int profundidad, int
// profundidad_max, color &c_piece, int &id_piece, int &dice, float alpha, float
// beta, Heuristic *heuristic);
